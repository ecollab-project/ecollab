...
// Use the same MySQL clock that ChatServer uses for validation. This avoids
// PHP/MySQL timezone differences on local XAMPP installations.
...
$db->prepare("
    ...
    VALUES (:uid, :hash, DATE_ADD(NOW(), INTERVAL 120 SECOND))
")->execute([
    ':uid'  => $user['id'],
    ':hash' => $tokenHash,
]);
