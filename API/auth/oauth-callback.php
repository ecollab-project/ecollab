...
try{$result=(new OAuthService())->handleCallback($provider,$code,$state);}catch(Throwable $e){ApiErrorResponder::log('auth/oauth-callback',$e);$result=['success'=>false,'error'=>'SSO sign-in could not be completed. Please try again.'];}
