...
(function () {
  ...
  function ensureStyles(){
    ...
    s.textContent=`
      ...
      .tv2-meta{display:flex;align-items:center;gap:7px;font-size:10px;color:var(--text-muted);margin-bottom:8px}.tv2-scope{padding:2px 7px;border-radius:999px;background:rgba(168,85,247,.1);color:#c084fc;font-weight:700}.tv2-card h3{margin:0 0 6px;font-size:15px;color:var(--text-primary);line-height:1.35}.tv2-card p{margin:0;color:var(--text-secondary);font-size:12px;line-height:1.55;white-space:pre-wrap;word-break:break-word}.tv2-card-media{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:8px;margin:10px 0 12px}.tv2-card-media img{display:block;width:100%;height:180px;object-fit:cover;border-radius:9px;border:1px solid var(--border);background:var(--bg-tertiary)}.tv2-author{font-weight:700;color:var(--text-primary)}
  ...
  function threadSignature(t){return JSON.stringify([t.id,t.title,t.body,t.scope,t.created_at,t.updated_at,t.reply_count,t.score,t.my_vote,t.server_name,t.channel_name,(t.attachments||[]).map(a=>[a.id,a.reply_id,a.file_url,a.file_name,a.mime_type])]);}
