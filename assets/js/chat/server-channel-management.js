...
(function () {
  ...
  async function renderServerMembers(body){
    ...
    window.scmAddMember=async uid=>{try{await request('/API/server/members.php','add',{},'POST',{server_id:id,user_id:uid});toast('Member added','success');await search();await loadServerMembers();}catch(e){toast(e.message,'error');}};
