...
class ChatServer implements MessageComponentInterface
{
    ...
    private function handleAuth(ConnectionInterface $conn, array $data, array &$meta): void
    {
        ...
        // Do NOT delete the token here. The browser can legitimately have more
        // than one chat bootstrap/tab during page load. The token remains bound
        // to the authenticated user and expires after the short ws-token window.
        // This prevents a duplicate socket from invalidating the good socket.
        $userId = (int)$user['id'];
