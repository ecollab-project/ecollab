...
class ChatServer implements MessageComponentInterface
{
    ...
    public function onMessage(ConnectionInterface $from, $rawMsg): void
    {
        ...
        match ($type) {
            ...
            'dm_call_renegotiate' => $this->handleDmCallSignal($from, $data, $meta, 'dm_call_renegotiate'),
            'dm_call_renegotiate_answer' => $this->handleDmCallSignal($from, $data, $meta, 'dm_call_renegotiate_answer'),
