...
/**
 * Phase 4.6 schema guard.
 *
 * The canonical schema lives in database/migrations/019_invites_and_members.sql.
 * This small guard keeps existing XAMPP installs working when that migration
 * has not yet been executed locally. It is idempotent and does not modify data.
 */
function ensurePhase46Schema(PDO $db): void
{
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS channel_invites (
        id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
