...
<body>
  ...
  <script src="<?= BASE_URL ?>/assets/js/chat/chat.js?v=avatar-sync-2" defer></script>
  ...
  <script src="<?= BASE_URL ?>/assets/js/chat/peer-matching.js?v=avatar-sync-2" defer></script>
