...
<div class="monitor-shell">
  ...
  <section id="tab-members" class="panel"><div class="card"><div class="ct">Members</div><?php foreach($members as $m):?><div class="row"><span><?=h($m['full_name'])?> <small>@<?=h($m['username'])?> · <?=h($m['server_role'])?></small></span><span><?=number_format((int)$m['messages'])?> messages · <?=h($m['status'])?></span></div><?php endforeach;?></div></section>
