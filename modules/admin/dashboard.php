...
<div class="dashboard-empty-state">No active servers found.</div>
    ...
    <div class="page-section" id="page-channels">
      ...
      <div class="card"><div class="card-header"><div class="card-title">All Channels</div></div><div id="channelsList">
        <div class="channel-item"><div class="ch-type-icon">#</div><span class="ch-name">#general</span><span class="ch-badge">Text</span><span style="color:var(--muted);font-size:11px;margin-left:auto;margin-right:12px"><?= number_format((int)($stats['total_users'] ?? 0)) ?> members</span><div class="action-btns"><button class="btn-view" onclick="openModal('editChannelModal','#general')">Edit</button><button class="btn-sm btn-outline" onclick="openChannelPermissions(this.closest('.channel-item')?.querySelector('.ch-name')?.textContent||'Channel')">Permissions</button><button class="btn-deny" onclick="openModal('deleteChannelModal','#general')">Delete</button></div></div>
        <div class="channel-item"><div class="ch-type-icon">#</div><span class="ch-name">#announcements</span><span class="ch-badge">Text</span><span style="color:var(--muted);font-size:11px;margin-left:auto;margin-right:12px"><?= number_format((int)($stats['total_users']??892)) ?> members</span><div class="action-btns"><button class="btn-view" onclick="openModal('editChannelModal','#announcements')">Edit</button><button class="btn-sm btn-outline" onclick="openChannelPermissions(this.closest('.channel-item')?.querySelector('.ch-name')?.textContent||'Channel')">Permissions</button><button class="btn-deny" onclick="openModal('deleteChannelModal','#announcements')">Delete</button></div></div>
        <div class="channel-item"><div class="ch-type-icon">🔊</div><span class="ch-name">Voice Room 1</span><span class="ch-badge">Voice</span><span style="color:var(--muted);font-size:11px;margin-left:auto;margin-right:12px">12 active</span><div class="action-btns"><button class="btn-view" onclick="openModal('editChannelModal','Voice Room 1')">Edit</button><button class="btn-sm btn-outline" onclick="openChannelPermissions(this.closest('.channel-item')?.querySelector('.ch-name')?.textContent||'Channel')">Permissions</button><button class="btn-deny" onclick="openModal('deleteChannelModal','Voice Room 1')">Delete</button></div></div>
        <div class="channel-item"><div class="ch-type-icon">🎨</div><span class="ch-name">Whiteboard Studio</span><span class="ch-badge">Whiteboard</span><span style="color:var(--muted);font-size:11px;margin-left:auto;margin-right:12px">8 active</span><div class="action-btns"><button class="btn-view" onclick="openModal('editChannelModal','Whiteboard Studio')">Edit</button><button class="btn-sm btn-outline" onclick="openChannelPermissions(this.closest('.channel-item')?.querySelector('.ch-name')?.textContent||'Channel')">Permissions</button><button class="btn-deny" onclick="openModal('deleteChannelModal','Whiteboard Studio')">Delete</button></div></div>
      </div></div>
    </div>
